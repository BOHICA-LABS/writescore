...
- **`.github/workflows/ci.yml`**: Continuous integration workflow
  ...
  - Test job: Matrix testing on Python 3.9, 3.10, 3.12
...
- **Python 3.8 support**: Dropped due to spacy 3.8.x requiring NumPy 2.0+, which requires Python 3.9+. Python 3.8 reached end-of-life in October 2024.
